...
class Config(DefaultConfig):
    ...
    admin_emails = ["mmheyer@umich.edu"]
    ...
    registration_only_by_superuser = False  # True disables self-registration, recommended for public wikis
    registration_hint = (
